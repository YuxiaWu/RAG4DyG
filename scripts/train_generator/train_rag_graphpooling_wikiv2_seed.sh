...
do
    ...
    export output="output/wikiv2/generator/graphfusion/$Timestamp/{$seed}/gpt2"
    
    export TRAIN_INDEX_FILE="./resources/train_generator/wikiv2/$Timestamp/train_gt_topk/train_index.gen"
    export TRAIN_SCORE_FILE="./resources/train_generator/wikiv2/$Timestamp/train_gt_topk/train_score.gen"

    export TEST_INDEX_FILE="./resources/retrieval_result/wikiv2/$RETRIEVAL_TYPE/test_index.gen"
    export TEST_SCORE_FILE="./resources/retrieval_result/wikiv2/$RETRIEVAL_TYPE/test_score.gen"
    
    export VAL_INDEX_FILE="./resources/retrieval_result/wikiv2/$RETRIEVAL_TYPE/val_index.gen"
    export VAL_SCORE_FILE="./resources/retrieval_result/wikiv2/$RETRIEVAL_TYPE/val_score.gen"
