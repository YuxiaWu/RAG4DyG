...
do
    ...
    export output="output/UCI_13/generator/graphfusion/$Timestamp/{$seed}/gpt2"
    
    export TRAIN_INDEX_FILE="./resources/train_generator/UCI_13/$Timestamp/train_gt_topk/train_index.gen"
    export TRAIN_SCORE_FILE="./resources/train_generator/UCI_13/$Timestamp/train_gt_topk/train_score.gen"

    export TEST_INDEX_FILE="./resources/retrieval_result/UCI_13/test_index.gen"
    export TEST_SCORE_FILE="./resources/retrieval_result/UCI_13/test_score.gen"
    
    export VAL_INDEX_FILE="./resources/retrieval_result/UCI_13/val_index.gen"
    export VAL_SCORE_FILE="./resources/retrieval_result/UCI_13/val_score.gen"
